...
<head>
    <title>Online Railway Catering Management System|| View Order Details</title>
...
<td colspan="2" style="font-size:20px;color:blue">
 User Details</td></tr>
  ...
  <tr>
<th>PNR Number:</th>
<td><?php echo $row['PNRNumber']?></td></tr>
<tr> 
<th>Train Name:</th>
...
<tr>
<th>Train Number :</th>
<td><?php echo $row['TrainNumber']?></td></tr>
<tr>
<th>Coach:</th>
...
<tr>
    ...
    <textarea name="restremark" placeholder="" rows="6" cols="14" class="form-control wd-450" required="true"></textarea></td>
  </tr>
...
<?php elseif($orserstatus=="Order Confirmed" ): ?>
 ...
 <?php elseif($orserstatus=="Food being Prepared"): ?>
         <option value="Food Pickup">Food Pickup</option>
     <option value="Food Delivered">Food Delivered</option>
      <?php elseif($orserstatus=="Food Pickup"): ?>
         <option value="Food Delivered">Food Delivered</option>
     <?php endif;?>
   </select></td>
  </tr>
