...
<head>
    ...
    <title>Online Railway Catering Management System|Manage Food Details</title>
...
?>
              <tbody>
                <tr>
                  ...
                  <td><a href="editfooditem.php?editid=<?php echo $row['ID'];?>" class="btn btn-primary">Edit</a> | 
                    <a href="manage-fooditems.php?delfood=<?php echo $row['ID'];?>" onclick="return confirm('Do you really want to delete the food item?');" class="btn btn-danger">Delete</a>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
