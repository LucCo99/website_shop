...
if(isset($_POST['submit']))
  {
   ...
   $itempic=$_FILES["itemimages"]["name"];
    ...
    echo "<script>alert('Food Item has been Updated.');</script>";
  }
  else
    {
...
<head>
    <title>Online Railway Catering Management System|Update Food Details</title>
...
<select name='foodcategory' id="foodcategory" class="form-control white_bg" required="true">
