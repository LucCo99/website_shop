...
<head>
    ...
    <title>Online Railway Catering Management System| Reset Password</title>
...
<body class="gray-bg">
    ...
    <div class="loginColumns animated fadeInDown">
        <div class="row">
            ...
            <div class="col-md-12">
                <h2 class="font-bold">Online Railway Catering Management System | Admin  Reset Password</h2>
