...
<head>
    ...
    <title>Online Railway Catering Management System||Cancelled Order</title>
...
<body>
    ...
    $next_page = $page_no + 1;
    $adjacents = "2"; 
    $result_count = mysqli_query($con,"SELECT COUNT(*) As total_records FROM tblorderaddresses where OrderFinalStatus='Order Cancelled'");
