...
<head>
    ...
    <title>Online Railway Catering Management System||Between Dates Report in Details</title>
...
<?php } else { ?>                  <td><?php  echo htmlentities($row['OrderFinalStatus']);?>
                  ...
                  <?php } ?>
                                    <td><a href="viewfoodorder.php?orderid=<?php echo $row['Ordernumber'];?>" class="btn btn-success">View Details</a>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
...
$cnt=$cnt+1;
            ...
            </table><div class="pagination-wrapper text-center">
                                    <ul class="pagination justify-content-center">
