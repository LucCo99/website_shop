...
<head>
    ...
    <title>Online Railway Catering Management System||All Order</title>
...
<body>
    ...
    $next_page = $page_no + 1;
    $adjacents = "2"; 
    $result_count = mysqli_query($con,"SELECT COUNT(*) As total_records FROM tblorderaddresses");
    $total_records = mysqli_fetch_array($result_count);
    $total_records = $total_records['total_records'];
    $total_no_of_pages = ceil($total_records / $total_records_per_page);
    $second_last = $total_no_of_pages - 1; // total page minus 1
$ret=mysqli_query($con,"select * from tblorderaddresses LIMIT $offset, $total_records_per_page");
$cnt=1;
