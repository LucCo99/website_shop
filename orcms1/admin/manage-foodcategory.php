...
<head>
    ...
    <title>Online Railway Catering Management System|| Manage Food Category</title>
...
?>
              <tbody>
                <tr>
                  ...
                  <td><a href="editcategory.php?editid=<?php echo $row['ID'];?>" class="btn btn-primary">Edit</a> | 
                    <a href="manage-foodcategory.php?del=<?php echo $row['ID'];?>"  onclick="return confirm('Do you really want to delete the category?');" class="btn btn-danger">Delete</a>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
