...
<head>
    ...
    <title>Online Railway Catering Management System||Search Order</title>
...
$ret=mysqli_query($con,"select * from tblorderaddresses where Ordernumber like '$sdata%' LIMIT $offset, $total_records_per_page");
