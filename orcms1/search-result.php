...
<head>
    ...
    <title>Online Railway Catering Management System|| Search Result</title>
                ...
                <div class="page-title-wrapper text-center">
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <div class="page-title-inner">
                            <h1 itemprop="headline">Search Results against keyword "<?php echo $_POST['searchdata'];?>"</h1>
                        </div>
                    </div>
                </div>
            </div>
...
<button type="submit" name="addcart" class="btn  pull-right red-bg brd-rd3">Order Now</button>
                              ...
                              <?php } } else { ?>
                                <h4 align="center" style="color:red">No Food found</h4>
                            <?php } ?>
                                    </div>
                                </div>
