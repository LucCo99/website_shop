...
error_reporting(0);
            ...
            <div class="topbar">
                <div class="container">
                    ...
                    <div class="topbar-register">
                         <?php if (strlen($_SESSION['orcmsuid']==0)) {?> 
                ...
                <?php }?>
                     <?php if (strlen($_SESSION['orcmsuid']>0)) {?>
                             <a  href="my-account.php" title="My Account" itemprop="url">My Orders</a> | 
   <a  href="my-account.php" title="My Account" itemprop="url">My Account</a> 
            ...
            <div class="logo-menu-sec">
                <div class="container">
                    <div class="logo"><h1 itemprop="headline"><a href="index.php" title="Home" itemprop="url">Thanh Trang</a></h1></div>
                    <nav>
                        <div class="menu-sec">
                            <ul>
                               <li><a >ㅤ ㅤ ㅤ ㅤ</a></li>
...
<li class="menu-item-has-children"><a href="our-menu.php" title="RESTAURANTS" itemprop="url">Category</a>
...
<?php if (strlen($_SESSION['orcmsuid']==0)) {?> 
    <a class="log-popup-btn black-bg brd-rd4" href="#" title="Login" itemprop="url">My Cart</a> 
<?php }?>

<?php if (strlen($_SESSION['orcmsuid']>0)) {?>
    <a class="log-popup-btn black-bg brd-rd4" href="cart.php" title="Register" itemprop="url">My Cart</a>
<?php } ?>
                        </div>
                    </nav><!-- Navigation -->
                </div>
        ...
        <div class="responsive-header">
            ...
            <div class="responsive-logomenu">
                <div class="logo"><h1 itemprop="headline"><a href="index-2.html" title="Home" itemprop="url">ORCMS</h1></div>
