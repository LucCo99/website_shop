                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-lg-6">
                                        <div class="widget about_widget wow fadeIn" data-wow-delay="0.1s">
                                                        <div class="logo"><h1 itemprop="headline"><a href="index.php" title="Home" itemprop="url" style="color:#fff">Thanh Trang Cosmetics</a></h1></div>
                                            <div class="logo"><p1 itemprop="headline"><a href="index.php" title="Home" itemprop="url" style="color:#fff">Nhận ưu đãi cho khách hàng mới</a></p1></div>
                                    ...
                                    <div class="col-md-2 col-sm-6 col-lg-2">
                                        <div class="widget get_in_touch wow fadeIn" data-wow-delay="0.4s">
                                            <h4 class="widget-title" itemprop="headline">Admin</h4>
                                            <ul>
